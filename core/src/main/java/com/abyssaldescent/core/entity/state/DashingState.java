...
/**
 * Karin dashes in her current facing direction with i-frames.
 * Duration: {@link PlayerContext#DASH_DURATION}.
 * Grants invincibility for {@link PlayerContext#DASH_I_FRAMES}.
 */
