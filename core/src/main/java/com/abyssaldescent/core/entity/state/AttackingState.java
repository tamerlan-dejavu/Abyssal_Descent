...
/**
 * Karin performs a melee swing. She cannot move during the attack window.
 * On enter, fires a {@link PlayerAttackEvent} so the combat system can
 * resolve hits. After {@link PlayerContext#ATTACK_DURATION} elapses,
 * transitions back to Idle (or Walking if movement input is held).
 */
